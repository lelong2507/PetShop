<%@ page import="org.example.PetShop.entity.User" %><%-- Document : index.jsp Created on : 24 thg 5, 2024, 07:44:15 Author :
...
<html>
  ...
  <body>
    <div class="img-begin">
      <img
        src="/images/intro-begin/intro.jpg"
        class="img-fluid"
...
<%--            Kiểm tra người dùng đã đăng nhập hay chưa--%>
            <%
              ...
              if (user != null) {
            %>
              <img src="/images/${sessionScope.user.imgAvatar}" alt="avatar" />
            <%
            } else {
            %>
              <a href="/login" class="me-3" id="user-icon">
    ...
    >
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img
            src="/images/slide/khuyen-mai-thuc-an-hat-royal-canin-m1-t1_1880_x_720_px.webp"
            class="d-block w-100"
            alt="First slide"
          />
        </div>
        <div class="carousel-item">
          <img
            src="/images/slide/khuyen-mai-san-pham-tri-ve-ran-cho-meo_1880_x_720_px.webp"
            class="d-block w-100"
            alt="Second slide"
          />
        </div>
        <div class="carousel-item">
          <img
            src="/images/slide/khuyen-mai-pate-royal-canin-30_1880_x_720_px.webp"
            class="d-block w-100"
            alt="Third slide"
          />
        </div>
        ...
        <div class="row wrapper-category">
          <div class="col-md-6 wrapper-content">
            <a href="./pages/pet-page/dog-page.jsp">
              <img
                src="/images/banner/dog_banner_1370x.webp"
                class="img-fluid"
                alt=""
              />
            </a>
          ...
          <div class="col-md-6 wrapper-content">
            <a href="./pages/pet-page/cat-page.jsp">
              <img
                src="/images/banner/cat_banner_1370x.webp"
                class="img-fluid"
                alt=""
              />
            </a>
      ...
      <div class="container">
        <div class="row align-items-center footer-content">
          ...
          <div class="col-md-3 text-center d-flex justify-content-between">
            <a
              ><img
                src="/images/social-icon/facebook_e3e340acee344ebd8bb196d37d0cef87.webp"
                class="img-fluid"
                alt=""
                width="30"
                height="30"
            ...
            <a
              ><img
                src="/images/social-icon/momo_logo_63183e1975424c0aade4b84e605ae0a2.webp"
                class="img-fluid"
                alt=""
                width="30"
                height="30"
            ...
            <a
              ><img
                src="/images/social-icon/shoppe-pay.webp"
                class="img-fluid"
                alt=""
                width="30"
                height="30"
            ...
            <a
              ><img
                src="/images/social-icon/vnp_322d4deedfa64e64a03900c8341c0317.webp"
                class="img-fluid"
                alt=""
                width="30"
                height="30"
