      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="content">
              <ul>
                <b>Cửa hàng thú cưng Paddy Pet Shop </b>
                <li>
                  Cửa hàng 1: 168 Trường Sa, Phường 1, Q. Bình Thạnh, Tp. Hồ Chí
                  Minh
                </li>
                <li>
                  Cửa hàng 2: 412/3 Nơ Trang Long, P. 13, Q. Bình Thạnh, Tp. Hồ
                  Chí Minh
                </li>
                <li>Hotline: 0374 414142</li>
                <li>Instagram: @petshop</li>
                <li>Website: petshop.vn</li>
              </ul>
            </div>
          </div>
        </div>
