...
<%
    ...
    String seeUserName = (currentSession != null) ? (String) currentSession.getAttribute("seeUserName") : null;

    // Debugging: Print session status and seeUserName
    System.out.println("Current Session: " + currentSession);
    System.out.println("seeUserName: " + seeUserName);

    if (seeUserName != null) {
        response.sendRedirect("pages/profile/profile-main.jsp");
        return;
    }
%>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div class="form-login">
            ...
            <hr />
            <form action="/PetShop/login" method="post" class="text-center">
                <input type="text" placeholder="UserName" name="userName" />
                <input type="password" placeholder="Password" name="passWord" />
                <div class="submit__here">
